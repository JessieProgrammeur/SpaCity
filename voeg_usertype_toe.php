...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit']) && !empty($_POST['submit'])){
    ...
    $sql = "INSERT INTO usertype VALUES(NULL, :type, :created_at, :updated_at)";
    ...
    $db = new db();
    $db->insert($sql, $placeholder, "overzicht_usertype.php");
}
...
<body>
    ...
    <form action="voeg_usertype_toe.php" method="post">
    <input type="text" class="form-control" name="type" placeholder="type"
        ...
        <input type="submit" class="btn btn-primary btn-block" name="submit" value="Usertype Toevoegen" />
