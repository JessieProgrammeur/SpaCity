...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit']) && !empty($_POST['submit'])){
    ...
    $type = trim(strtolower($_POST['type']));
        ...
        $db = new db();
        $sql = "UPDATE usertype SET type=:type
                WHERE id=:id";
        $placeholder = ['type' => $type, 'id' => $_POST['usertype_id']];
        $db->update_or_delete($sql, $placeholder, "overzicht_usertype.php");
    }
...
<body>
    ...
    <form action="edit_usertype.php" method="post">
        <input type="hidden" name="usertype_id" value="<?php echo ($_GET["id"])?>">
        <input type="text" class="form-control" name="type" placeholder="type"
            value="<?php echo isset($_POST["type"]) ? htmlentities($_POST["type"]) : ''; ?>" required /><br>
        ...
        <input type="submit" class="btn btn-primary btn-block" name="submit" value="Usertype Wijzigen" />
