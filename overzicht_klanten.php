<?php
    ...
    if(isset($_POST['export'])){
        ...
        $result = $db->select("SELECT klanten.id, klanten.naam, klanten.adres, klanten.postcode, klanten.plaats, klanten.telefoonnummer, klanten.email, klanten.betalingen_id, klanten.created_at, klanten.updated_at 
        FROM klanten
