    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5">
                        <h2>Producten <b>Bestand</b></h2>
                    </div>
                    <div class="col-sm-7">
                        <a href="voeg_klant_toe.php" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span>Voeg Product Toe</span></a>
    ...
    <?php
        ...
        while (($row = fgetcsv($fp)) !== false) {
            ...
            <tr>
                ...
                <td class="<?php echo $class; ?>"><?php echo $row[24]; ?></td>
                <td class="<?php echo $class; ?>"><?php echo $row[25]; ?></td>
                <td class="<?php echo $class; ?>"><?php echo $row[26]; ?></td>
            </tr>
        <?php
            $i ++;
        }
